...
export declare type SyncExpression<T extends PersistentModel> = Promise<{
    modelConstructor: PersistentModelConstructor<T>;
    conditionProducer: ProducerModelPredicate<T> | (() => ProducerModelPredicate<T>);
}>;
export declare function syncExpression<T extends PersistentModel, P>(modelConstructor: PersistentModelConstructor<T>, conditionProducer: (condition: P | ModelPredicate<T>) => P extends ModelPredicate<T> ? ModelPredicate<T> : ProducerModelPredicate<T>): Promise<{
    modelConstructor: PersistentModelConstructor<T>;
    conditionProducer: (condition: P | ModelPredicate<T>) => P extends ModelPredicate<T> ? ModelPredicate<T> : ProducerModelPredicate<T>;
}>;
